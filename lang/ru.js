...
module.exports = {
    ...
    translate: {
        ...
        QUEUE : {
            ...
            DONT_HAVE_ITEMS: "Очередь аукциона пуста или не отслеживается!",
            EMBED: {
                TITLE: "Очередь аукциона",
                FIELDS: {
                    LVL: "lvl",
        ...
        TRACK : {
            ...
            ADD: {
                LIMITE_ERROR: (count) => { return `Достигнут лимит на ${count} отслеживаемых групп товаров для сервера! Удалите какую-нибудь группу для создания новой.` },
                ...
                ERROR_2: (count) => { return `В одной группе может быть не более ${count} предметов!` },
